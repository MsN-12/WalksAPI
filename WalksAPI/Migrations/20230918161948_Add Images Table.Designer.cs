...
namespace WalksAPI.Migrations
{
    ...
    [Migration("20230918161948_Add Images Table")]
            ...
            modelBuilder.Entity("WalksAPI.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7422fe3f-f5a6-4762-b0f9-35ce5c6f6f3a"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("a28f1267-ba3f-4d82-af8a-8f051e9dc01f"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("ce696f7d-db6c-46b4-a2b1-8806d4b00b25"),
                            Name = "Hard"
                        });
                });
